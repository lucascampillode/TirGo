...
if __name__ == "__main__":
    ...
    #]
    checkpoints = [
        [1.4998722751648397, -0.7247556435570256, 0.989510915323257, 0.14445812007682451] ,  # Inicio
        [1.4855055042601835, -1.8193396267281166, -0.779451552008702, 0.6264625113055255]
    ]
    follower = Follower()
