...
| **Control Mecánico:** Atasco del medicamento en la tolva o rampa. | Medio | Uno de los problemas del control mecánico del dispensador es la deposición no centrada del bote en la tolva, lo que provoca un empuje fuera de eje y compromete la correcta ejecución del ciclo de dispensación. Según su orientación y la carga de comprimidos, el contenedor puede generar bloqueos internos. Asimismo, los actuadores tipo pusher pueden desviarse de su posición de referencia, alterando el recorrido efectivo y la fuerza transmitida, y derivando en fallos repetitivos del mecanismo. |
